...
2. Entrar al directorio y copiar los archivos obtenidos del cálculo en el directorio /data. 

3. Abrir el script app.R en Rstudio y clickear "Run App".

## Pendientes

Queda pendiente por desarrollar las secciones de "Datos reales", "Datos desestacionalizados" y "Brechas".
